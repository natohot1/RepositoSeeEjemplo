...
import com.jarabe.seeejemplo.accesorio.IndiceAsma4;
import com.jarabe.seeejemplo.accesorio.Jarabes;
...
public class Asma extends AppCompatActivity {
    ...
    TextView txTitulo, txCantidad, txCada, txGravedad,txOtras, txPrecausiones,txPeso, txotrasNoPro, txIndiBude;
    ...
    private void inicializarComponentes() {
        ...
        txIndiBude = findViewById(R.id.textView6);
    ...
    private void dosisAlternativas() {
        ...
        if (medicamen_final.contains("BUDESON")){
            ...
            txPeso.setText("");
            txIndiBude.setEnabled(true);
            txIndiBude.setLines(2);
            txIndiBude.setText(" De 6 meses a 12 años, maximo 2 mg/dia, \n en casos muy graves hasta 4 mg/dia");
        }
    }
